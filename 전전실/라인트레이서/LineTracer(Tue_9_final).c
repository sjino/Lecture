...
#define TURNING_TIME  30363366666666666//약 0.41초마다 타이머 반복 //111 (1/(16000000/256/1024))
#define RESET_TIME 120 //약 2초마다 타이머 반복 //111 (1/(16000000/256/1024))
#define DELAY_TIME 3 //딜레이 값 

volatile int delay_t = 0; //딜레이값 저장
volatile int error_timer = 0;
		...
		if (mode == DRIVE)
		{
			...
			case 0x03: //0011 오른쪽 네모인식 (우회전 신호)
				...
				if (turn_right_signal==0)
				{
					...
					delay_t = DELAY_TIME + 1; //딜레이 증가 //속도 감속
